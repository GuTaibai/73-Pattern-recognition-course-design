...
class MainWindow(QtWidgets.QMainWindow, Yolo2onnx_detect_Demo_UI.Ui_MainWindow):
    ...
    def loadConfig(self):  # 加载配置
        ...
        self.lineEdit_3.setText(cfg.search('root', 'model_path', os.path.join('need', 'models', 'best.onnx')))
        self.class_file = cfg.search('root', 'class_path', os.path.join('need', 'best.txt'))
